...
enum ExportError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .cardsOnly:
            return "This export would be cards, not a real video. Add a Pexels or Pixabay key, drop local footage, start ComfyUI at 127.0.0.1:8188, or check “cards ok” if you really want a type-card export."
        }
    }
}
